...
class Customer(models.Model):
    ...
    weekly_pickup_day = models.CharField(max_length=50, blank=True, default='')
    ...
    customer_address = models.CharField(max_length=50, blank=True, default='')
    customer_zip_code = models.CharField(max_length=50, blank=True, default='')
